...
#$servers= import-csv -Path  $currentpath\ilo.csv
$servers= import-csv -Path  "C:\Users\v.kalinin\Desktop\WorkScripts\scripts 100\ilo.csv" -Delimiter "`t"
foreach ($server in $servers)

{ #foreach start
$ip=$server.IPV4Address.ToString()
$defaultpass=$server.pass.ToString()
$ip
$defaultpass
